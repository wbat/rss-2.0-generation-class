...
namespace RSS_Generation_Class;
...
class rss {
	...
	$this->rss .= '<?xml-stylesheet type="text/css" media="screen" href="http://www.signera.net/attachments/rss-itemcontent.css"';
	$this->rss .= '?>'. "\n";
	$this->rss .= '<rss version="2.0" xmlns:media="http://search.yahoo.com/mrss/" xmlns:feedburner="http://rssnamespace.org/feedburner/ext/1.0">'. "\n";
